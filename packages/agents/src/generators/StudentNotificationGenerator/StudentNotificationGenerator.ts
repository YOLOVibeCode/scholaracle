...
/**
 * Generates student-facing notifications from alerts.
 * Uses direct, clear messaging telling students what to do.
 */
export class StudentNotificationGenerator implements INotificationGenerator {
  ...
  public generate(alert: Alert): Notification {
    ...
    return new Notification({
      ...
      userId: alert.studentId, // Student is the user
      subject,
      body,
