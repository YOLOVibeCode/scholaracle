...
async function handleSeed(req: Request, res: Response, config: ISeedRouterConfig): Promise<void> {
  ...
  if (nodeEnv === 'production') {
    throw new ForbiddenError('Seeding is not allowed in production');
  }
...
async function handleDemoSeed(
  ...
  if (!isDemoAllowed()) {
    throw new ForbiddenError('Demo is not enabled');
  }
...
export function seedRouter(config: ISeedRouterConfig): Router {
  ...
  router.post(
    '/',
    asyncHandler((req: Request, res: Response) => handleSeed(req, res, config))
  );
  ...
  router.post(
    '/demo',
    asyncHandler((req: Request, res: Response) => handleDemoSeed(req, res, config))
  );
  ...
  router.post(
    '/demo/reset',
    asyncHandler((req: Request, res: Response) => handleDemoReset(req, res, config))
  );
  ...
  router.post(
    ...
    asyncHandler(async (req: Request, res: Response) => {
      ...
      if (!studentId || !email) {
        throw new ValidationError('Missing studentId or email');
      }
