...
test.describe('@navigation Layer 3: Admin Navigation', () => {
  test('NAV-A-001: Dashboard link works', async ({ page, loginAsRole }) => {
  ...
  test('NAV-A-002: Customers link works', async ({ page, loginAsRole }) => {
    await loginAsRole('admin');
  ...
  test('NAV-A-003: Payments link works', async ({ page, loginAsRole }) => {
    await loginAsRole('admin');
    await page.goto('/admin/dashboard');
  ...
  test('NAV-A-004: Subscriptions link works', async ({ page, loginAsRole }) => {
    await loginAsRole('admin');
    await page.goto('/admin/dashboard');
  ...
  test('NAV-A-005: Communications link works', async ({ page, loginAsRole }) => {
    await loginAsRole('admin');
    await page.goto('/admin/dashboard');
  ...
  test('NAV-A-006: Reports link works', async ({ page, loginAsRole }) => {
    await loginAsRole('admin');
    await page.goto('/admin/dashboard');
  ...
  test('NAV-A-007: Settings link works', async ({ page, loginAsRole }) => {
    await loginAsRole('admin');
    await page.goto('/admin/dashboard');
  ...
  test('NAV-A-008: Audit Logs link works', async ({ page, loginAsRole }) => {
    await loginAsRole('admin');
    await page.goto('/admin/dashboard');
  ...
  test('NAV-A-012: Quick actions menu', async ({ page, loginAsRole }) => {
    ...
    const actionMenu = page
      .locator('[data-testid="action-menu"], button[aria-label*="Actions"]')
      .first();
