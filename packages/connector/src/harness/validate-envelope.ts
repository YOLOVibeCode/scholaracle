...
const VALID_ENTITIES: readonly SlcEntityType[] = [
  'assignment', 'eventSeries', 'eventOverride', 'academicTerm',
  'institution', 'course', 'gradeSnapshot', 'attendanceEvent',
  'teacher', 'courseMaterial', 'message',
];
...
export function validateEnvelope(
  ...
  checks.push(check(
    ...
    missingRecordCount > 0 ? `${missingRecordCount} upsert ops missing record` : 'All have records',
  ));
